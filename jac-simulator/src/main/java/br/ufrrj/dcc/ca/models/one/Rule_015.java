...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 15.
* <p>
* Rule 15 is a linear elementary cellular automaton where the next state of a cell
...
public class Rule_015 implements ElementaryRuleInterface { 
   /**
     ...
     */ 
     public String getRuleName() {return "Rule 15 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 15, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "00001111"; }
  /**
