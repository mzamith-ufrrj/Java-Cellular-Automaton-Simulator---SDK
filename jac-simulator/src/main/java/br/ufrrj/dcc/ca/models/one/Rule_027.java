...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 27.
* <p>
* Rule 27 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_027 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 27).
     */ 
     public String getRuleName() {return "Rule 27 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 27, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "00011011"; }
  /**
