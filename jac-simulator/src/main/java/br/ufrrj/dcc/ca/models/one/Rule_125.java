...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 125.
* <p>
* Rule 125 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_125 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 125).
     */ 
     public String getRuleName() {return "Rule 125 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 125, the center cell's current state is ignored. The result depends  
