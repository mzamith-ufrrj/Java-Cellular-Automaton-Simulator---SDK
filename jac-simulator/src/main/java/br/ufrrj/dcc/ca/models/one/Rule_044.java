...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 44.
* <p>
* Rule 44 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_044 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 44).
     */ 
     public String getRuleName() {return "Rule 44 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 44, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "00101100"; }
  /**
