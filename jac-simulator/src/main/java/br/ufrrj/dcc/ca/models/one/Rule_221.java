...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 221.
* <p>
* Rule 221 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_221 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 221).
     */ 
     public String getRuleName() {return "Rule 221 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 221, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "11011101"; }
  /**
