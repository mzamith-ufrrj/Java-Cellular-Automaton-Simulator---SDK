...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 76.
* <p>
* Rule 76 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_076 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 76).
     */ 
     public String getRuleName() {return "Rule 76 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 76, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "01001100"; }
  /**
