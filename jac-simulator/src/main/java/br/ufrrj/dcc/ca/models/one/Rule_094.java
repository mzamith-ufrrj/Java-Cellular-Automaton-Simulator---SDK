...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 94.
* <p>
* Rule 94 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_094 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 94).
     */ 
     public String getRuleName() {return "Rule 94 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 94, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "01011110"; }
  /**
