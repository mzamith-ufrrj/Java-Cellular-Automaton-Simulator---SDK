...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 230.
* <p>
* Rule 230 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_230 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 230).
     */ 
     public String getRuleName() {return "Rule 230 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 230, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "11100110"; }
  /**
