...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 166.
* <p>
* Rule 166 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_166 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 166).
     */ 
     public String getRuleName() {return "Rule 166 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 166, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "10100110"; }
  /**
