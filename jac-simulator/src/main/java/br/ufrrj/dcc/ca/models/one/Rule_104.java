...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 104.
* <p>
* Rule 104 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_104 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 104).
     */ 
     public String getRuleName() {return "Rule 104 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 104, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "01101000"; }
  /**
