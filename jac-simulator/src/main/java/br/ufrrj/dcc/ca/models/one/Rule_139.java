...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 139.
* <p>
* Rule 139 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_139 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 139).
     */ 
     public String getRuleName() {return "Rule 139 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 139, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "10001011"; }
  /**
