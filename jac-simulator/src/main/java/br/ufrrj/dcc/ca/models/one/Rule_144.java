...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 144.
* <p>
* Rule 144 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_144 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 144).
     */ 
     public String getRuleName() {return "Rule 144 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 144, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "10010000"; }
  /**
