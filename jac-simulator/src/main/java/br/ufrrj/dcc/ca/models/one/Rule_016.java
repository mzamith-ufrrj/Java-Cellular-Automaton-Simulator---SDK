...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 16.
* <p>
* Rule 16 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_016 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 16).
     */ 
     public String getRuleName() {return "Rule 16 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 16, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "00010000"; }
  /**
