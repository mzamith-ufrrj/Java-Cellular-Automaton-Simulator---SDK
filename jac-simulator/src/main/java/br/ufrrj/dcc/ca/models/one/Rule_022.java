...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 22.
* <p>
* Rule 22 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_022 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 22).
     */ 
     public String getRuleName() {return "Rule 22 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 22, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "00010110"; }
  /**
