...
/**
 * Implementation of Wolfram's Elementary Cellular Automaton Rule 090.
 * <p>
 ...
 * {@code (left AND NOT right) OR (NOT left AND right)}, which is equivalent to 
 * {@code left XOR right}.</p>
 * * @author Marcelo
 * @version 1.0
 * @see <a href="https://mathworld.wolfram.com/Rule90.html">Wolfram MathWorld - Rule 90</a>
 */
