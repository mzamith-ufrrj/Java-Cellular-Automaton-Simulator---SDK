...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 156.
* <p>
* Rule 156 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_156 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 156).
     */ 
     public String getRuleName() {return "Rule 156 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 156, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "10011100"; }
  /**
