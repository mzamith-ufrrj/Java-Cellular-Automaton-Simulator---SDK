...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 243.
* <p>
* Rule 243 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_243 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 243).
     */ 
     public String getRuleName() {return "Rule 243 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 243, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "11110011"; }
  /**
