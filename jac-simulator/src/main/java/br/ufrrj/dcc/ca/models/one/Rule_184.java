...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 184.
* <p>
* Rule 184 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_184 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 184).
     */ 
     public String getRuleName() {return "Rule 184 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 184, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "10111000"; }
  /**
