...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 134.
* <p>
* Rule 134 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_134 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 134).
     */ 
     public String getRuleName() {return "Rule 134 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 134, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "10000110"; }
  /**
