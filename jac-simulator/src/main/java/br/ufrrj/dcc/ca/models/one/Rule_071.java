...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 71.
* <p>
* Rule 71 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_071 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 71).
     */ 
     public String getRuleName() {return "Rule 71 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 71, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "01000111"; }
  /**
