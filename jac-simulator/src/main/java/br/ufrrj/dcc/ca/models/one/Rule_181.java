...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 181.
* <p>
* Rule 181 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_181 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 181).
     */ 
     public String getRuleName() {return "Rule 181 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 181, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "10110101"; }
  /**
