...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 189.
* <p>
* Rule 189 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_189 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 189).
     */ 
     public String getRuleName() {return "Rule 189 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 189, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "10111101"; }
  /**
