...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 87.
* <p>
* Rule 87 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_087 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 87).
     */ 
     public String getRuleName() {return "Rule 87 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 87, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "01010111"; }
  /**
