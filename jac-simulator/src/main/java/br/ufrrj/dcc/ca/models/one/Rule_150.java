...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 150.
* <p>
* Rule 150 is a linear elementary cellular automaton where the next state of a cell
...
public class Rule_150 implements ElementaryRuleInterface { 
   ...
   /**
     ...
     */ 
     public String getRuleName() {return "Rule 150 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 150, the center cell's current state is ignored. The result depends  
...
<<<<<<< HEAD
   ...
   */ 
   public String getBinary(){ return "10010110"; }
  /**
