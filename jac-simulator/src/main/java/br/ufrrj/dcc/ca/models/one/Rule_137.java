...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 137.
* <p>
* Rule 137 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_137 implements ElementaryRuleInterface { 
   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 137).
     */ 
     public String getRuleName() {return "Rule 137 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 137, the center cell's current state is ignored. The result depends  
