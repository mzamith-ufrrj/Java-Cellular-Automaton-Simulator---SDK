...
/**
* Implementation of Wolfram's Elementary Cellular Automaton Rule 25.
* <p>
* Rule 25 is a linear elementary cellular automaton where the next state of a cell
...
* @version 1.0
*/
public class Rule_025 implements ElementaryRuleInterface { 

   /**
     * Returns the formal name of the cellular automaton rule.
     * * @return A string representing the rule name (Rule 25).
     */ 
     public String getRuleName() {return "Rule 25 "; } 

   /** 
     * Applies the transition rule to determine the next state of a cell. 
     * <p> 
     * In Rule 25, the center cell's current state is ignored. The result depends  
   ...
   */ 
   public String getBinary(){ return "00011001"; }
  /**
